...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    per-application executor registry, circuit-breaker registry, and retry
    policy, then register only enabled-and-available agent adapters.
    ...
    is logged and skipped, not fatal to startup.
    """
    logger.info(
