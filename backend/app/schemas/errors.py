...
class APIErrorCode(StrEnum):
    ...
    AGENT_VERIFICATION_IN_PROGRESS = "AGENT_VERIFICATION_IN_PROGRESS"
    ORCHESTRATION_EXECUTION_NOT_FOUND = "ORCHESTRATION_EXECUTION_NOT_FOUND"
    ORCHESTRATION_EXECUTION_EXISTS = "ORCHESTRATION_EXECUTION_EXISTS"
    AGENT_CONNECTION_NOT_FOUND = "AGENT_CONNECTION_NOT_FOUND"
    CONNECTED_AGENT_NOT_FOUND = "CONNECTED_AGENT_NOT_FOUND"
    AGENT_CONNECTION_EXISTS = "AGENT_CONNECTION_EXISTS"
    CONNECTED_AGENT_EXISTS = "CONNECTED_AGENT_EXISTS"
    AGENT_CONNECTION_HAS_DEPENDENTS = "AGENT_CONNECTION_HAS_DEPENDENTS"
    INVALID_AGENT_CONNECTION_REFERENCE = "INVALID_AGENT_CONNECTION_REFERENCE"
